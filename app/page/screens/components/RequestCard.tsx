...
const styles = StyleSheet.create({
  card: {backgroundColor: "#fff",borderRadius: 16,padding: 12,marginBottom: 14,elevation: 2,},
  cardTop: {flexDirection: "row",gap: 12,},
  image: {width: 86,height: 86,borderRadius: 12,backgroundColor: "#F3F4F6",},
  placeholder: {justifyContent: "center",alignItems: "center",},
  cardInfo: {flex: 1,justifyContent: "center",gap: 4,},
  cardTitle: {fontSize: 15, fontWeight: "bold",color: "#111827",textAlign: "right",},
  cardText: {fontSize: 12,color: "#6B7280",textAlign: "right",},
  actions: {flexDirection: "row",gap: 10,marginTop: 12,},
  actionBtn: {flex: 1,paddingVertical: 11,borderRadius: 12,alignItems: "center",},
  acceptBtn: { backgroundColor: "#6A0DAD",},
